...
public class UserContoller {
	...
	@PostMapping("/saveChangeUserDetail")
	public GeneralResponse saveChangeUserDetail(@RequestBody User user) {

		try {
			System.out.println(user);
			userService.saveChangeUserDetail(user);
			return new GeneralResponse(true,"işlem başarılı",user);
		}catch(Exception e ) {
			System.out.println("hata yakalandı : ");
			return handleException(e);
		}
